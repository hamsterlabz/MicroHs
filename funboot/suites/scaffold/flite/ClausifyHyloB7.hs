...
main = --let p = eqv (eqv a $ eqv a a)
       ...
       display $ clausify $ foldr Con (Sym (0::Int)) $ replicate 7 (eqv (eqv (Sym (0::Int)) $ eqv (Sym (0::Int)) (Sym (0::Int))) (eqv (Sym (0::Int)) $ eqv (Sym (0::Int)) (Sym (0::Int))))
